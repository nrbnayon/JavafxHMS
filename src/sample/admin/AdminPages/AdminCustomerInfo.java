...
import sample.BackEnd.TableView.AdminCustomerTable;
import sample.admin.AdminPages.EditCustomerEmployee.CustomerInfoEdit;
    ...
    private void editTableRowInfo(AdminCustomerTable adminCustomerTable) {
        ...
        try {
            if (!connection.isClosed()) {
                ...
                loader.setLocation(getClass().getResource("/sample/admin/AdminPages/EditCustomerEmployee/CustomerInfoEdit.fxml"));
