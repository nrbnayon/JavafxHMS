...
import sample.BackEnd.DBConnection;
import sample.BackEnd.TableView.AdminEmployeeTable;
import sample.admin.AdminPages.EditCustomerEmployee.EmployeeInfoEdit;
    ...
    private void editTableRowInfo(AdminEmployeeTable adminEmployeeTable) {
        ...
        try {
            if (!connection.isClosed()) {
                ...
                loader.setLocation(getClass().getResource("/sample/admin/AdminPages/EditCustomerEmployee/EmployeeInfoEdit.fxml"));
