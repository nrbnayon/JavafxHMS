...
import sample.BackEnd.TableView.ManagerCheckOutTable;
...
import static sample.BackEnd.DBConnection.closeConnections;
import static sample.BackEnd.DBConnection.getConnections;
...
public class ManagerCheckOutDetails implements Initializable {
    ...
    public TableColumn<ManagerCheckOutTable, String> nameCol;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        nameCol.setCellValueFactory(new PropertyValueFactory<ManagerCheckOutTable, String>("name"));
        ...
        try {
            if(!connection.isClosed()){
                ...
                while (resultSet.next()){
                    ...
                    ManagerCheckOutTable roomTablee = new ManagerCheckOutTable(NID, NAME, ROOMNO, TYPE, CAPACITY, PRICEDAY, TOTALPRICE, CHECKEDIN, CHECKEDOUT);
